...
export default function Governance({
  ...
  const tokenAddress =
    readContracts && readContracts.CommunityBankingToken ? readContracts.CommunityBankingToken.address : null;
  const poolAddress =
  ...
  async function castVote(proposalId, support) {
    const result = tx(writeContracts.CommunityBankingGovernor.castVote(proposalId, support));
